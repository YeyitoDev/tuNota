...
var CANVAS_TEMPLATES = [
  ...
  },
  {
    ...
    desc: 'Componentes conectados con formas editables + notas de decisiones y riesgos.',
    icon: 'code',
    blocks: [
      { type: 'freetext', x: 0, y: -64, w: 620, h: 52, text: 'Arquitectura del sistema', style: { size: 30, bold: true } },
      { type: 'shape', x: 0, y: 170, w: 140, h: 60, shape: 'pill', text: 'Usuario' },
      { type: 'shape', x: 200, y: 168, w: 160, h: 64, shape: 'rect', text: 'Web / App' },
      { type: 'shape', x: 420, y: 168, w: 160, h: 64, shape: 'rect', text: 'API Gateway' },
      { type: 'shape', x: 650, y: 60, w: 150, h: 60, shape: 'round', text: 'Auth' },
      { type: 'shape', x: 640, y: 200, w: 180, h: 70, shape: 'rect', text: 'Servicio principal', color: 'n' },
      { type: 'shape', x: 900, y: 60, w: 170, h: 60, shape: 'round', text: 'Base de datos' },
      { type: 'shape', x: 900, y: 190, w: 150, h: 60, shape: 'round', text: 'Cache' },
      { type: 'shape', x: 900, y: 320, w: 150, h: 60, shape: 'round', text: 'Cola' },
      { type: 'shape', x: 1120, y: 318, w: 150, h: 64, shape: 'rect', text: 'Workers' },
      { type: 'text', x: 0, y: 330, w: 280, h: 130, text: 'Decisiones clave\n- \u00bfMonolito o servicios?\n- \u00bfSQL o NoSQL?' },
      { type: 'text', x: 320, y: 330, w: 280, h: 130, text: 'Riesgos\n- Punto \u00fanico de fallo\n- L\u00edmites de la cola' },
    ],
    links: [[1, 2], [2, 3], { a: 3, b: 4, label: 'valida', type: 'flow' }, [3, 5], [5, 6], [5, 7], { a: 5, b: 8, label: 'async', type: 'flow' }, [8, 9]],
  },
  {
    key: 'mvp',
    name: 'De la idea al despliegue',
    desc: 'Pipeline de MVP con decisiones: descubrir, validar, construir, medir y lanzar.',
    icon: 'play',
    blocks: [
      { type: 'freetext', x: 0, y: -64, w: 680, h: 52, text: 'De la idea al despliegue', style: { size: 30, bold: true } },
      { type: 'shape', x: 0, y: 70, w: 140, h: 60, shape: 'pill', text: 'Idea' },
      { type: 'shape', x: 210, y: 68, w: 180, h: 64, shape: 'rect', text: 'Descubrimiento' },
      { type: 'shape', x: 460, y: 48, w: 170, h: 100, shape: 'diamond', text: '\u00bfValidado?' },
      { type: 'shape', x: 700, y: 68, w: 160, h: 64, shape: 'rect', text: 'Definir el MVP' },
      { type: 'shape', x: 0, y: 320, w: 160, h: 64, shape: 'rect', text: 'Construir' },
      { type: 'shape', x: 230, y: 320, w: 140, h: 64, shape: 'rect', text: 'Medir' },
      { type: 'shape', x: 440, y: 300, w: 190, h: 100, shape: 'diamond', text: '\u00bfQu\u00e9 aprendimos?' },
      { type: 'shape', x: 700, y: 322, w: 180, h: 60, shape: 'pill', text: 'Lanzamiento \ud83d\ude80' },
    ],
    links: [
      [1, 2], [2, 3],
      { a: 3, b: 1, label: 'No', type: 'flow' },
      { a: 3, b: 4, label: 'S\u00ed', type: 'flow' },
      [4, 5], [5, 6], [6, 7],
      { a: 7, b: 1, label: 'Pivotar', type: 'flow' },
      { a: 7, b: 8, label: 'Perseverar', type: 'flow' },
    ],
  },
  {
    key: 'flow',
  ...
  },
  {
    key: 'vision',
    name: 'Vision board',
    desc: 'Tu visión en imágenes: pega una foto en cada cuadro y el cuadro se ajusta a ella.',
    icon: 'star',
    blocks: [
      { type: 'freetext', x: 0, y: -96, w: 700, h: 52, text: '✨ Mi vision board', style: { size: 30, bold: true } },
      { type: 'freetext', x: 0, y: -44, w: 880, h: 40, text: 'Pega una foto dentro de cada cuadro (' + MOD + '+V) o suéltala encima: el cuadro se ajusta solo al tamaño de la imagen. Doble clic en la foto para dibujar, señalar o recortar.', style: { size: 14 } },
      { type: 'shape', x: 440, y: 435, w: 240, h: 100, shape: 'pill', text: 'Mi visión' },
      { type: 'shape', x: 100, y: 40, w: 240, h: 170, shape: 'round', text: '💪 Salud y energía' },
      { type: 'shape', x: 440, y: 40, w: 240, h: 170, shape: 'round', text: '💰 Dinero y negocio' },
      { type: 'shape', x: 780, y: 40, w: 240, h: 170, shape: 'round', text: '🌍 Viajes' },
      { type: 'shape', x: 100, y: 400, w: 240, h: 170, shape: 'round', text: '❤️ Familia y amigos' },
      { type: 'shape', x: 780, y: 400, w: 240, h: 170, shape: 'round', text: '📚 Aprender' },
      { type: 'shape', x: 100, y: 760, w: 240, h: 170, shape: 'round', text: '🏡 Hogar' },
      { type: 'shape', x: 440, y: 760, w: 240, h: 170, shape: 'round', text: '⚡ Hábitos diarios' },
      { type: 'shape', x: 780, y: 760, w: 240, h: 170, shape: 'round', text: '🧘 Cómo me quiero sentir' },
    ],
    links: [[2, 3], [2, 4], [2, 5], [2, 6], [2, 7], [2, 8], [2, 9], [2, 10]],
  },
  {
    key: 'concept',
