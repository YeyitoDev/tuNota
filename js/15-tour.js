...
var TOUR_STEPS = [
  ...
  { sel: '#canvas', title: 'Escribe con formato', body: 'Dentro de una nota, marca texto y aparece encima una barra con negrita, subrayado, resaltado, listas, tipo de letra y color. El formato se ve al momento. También en los cuadros de texto libre.', place: 'center' },
  ...
  { sel: '[title^="Tablero de tareas"]', title: 'Tus tareas, en lista o en tablero', body: 'Un solo sitio para lo que tienes que hacer. En Lista ves el plan del día con sus pasos y cuánto llevas; en Tablero, lo mismo repartido en Por hacer · En progreso · Hecho. Se abre acoplado a un lado, así que puedes ordenar prioridades sin dejar de trabajar en el lienzo. Cada tarea se desglosa en pasos y cualquier texto se edita con doble clic.', place: 'bottom' },
