...
var GUIA_SECS = [
  ...
  { t: 'Organizar y actuar', items: [
    { img: '06-menu-tarjeta.png', t: 'Escribir con formato, como en un procesador de textos', b: 'Marca texto dentro de una nota, una idea o un cuadro de texto libre y aparece justo encima una barra de dos filas. Arriba lo de cada momento: negrita, cursiva, subrayado, tachado, resaltado y código (también con ⌘/Ctrl+B, I, U), títulos y cita, listas numeradas, con viñetas o de casillas, y sangría. Abajo lo que se ajusta de vez en cuando: tipo de letra, tamaño, alineación, color del texto y de fondo, enlace, quitar formato y línea separadora. El formato se ve al momento, no como símbolos: lo que marcas es lo que queda. Por dentro cada nota guarda su versión con formato y, a la vez, una en texto plano, que es la que leen la IA, el buscador y las tareas. Las notas que ya tenías se convierten solas la primera vez que las abres.' },
    ...
    { img: '12-kanban.png', t: 'Tareas: plan del día y tablero, unidos', b: 'El plan del día y el Kanban son lo mismo visto de dos maneras. En Lista respondes a «qué tengo hoy y cuánto llevo»; en Tablero, a «en qué estado está cada cosa» (Por hacer · En progreso · Hecho). El panel va acoplado a un lado, así que puedes ordenar prioridades mientras sigues moviendo tarjetas en el lienzo (arrastra su borde para darle más sitio, o ponlo como ventana centrada). Cada tarea —y cada tarjeta del lienzo— se desglosa en pasos con su barra de progreso; marcar el primer paso la pone en marcha sola. Prioridad y estado se eligen de una lista desplegable, hay filtros por fecha (hoy, semana, atrasadas o un rango) y doble clic edita cualquier texto.' },
  ] },
