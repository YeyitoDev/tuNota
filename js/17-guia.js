...
var GUIA_SECS = [
  ...
  { t: 'Organizar y actuar', items: [
    ...
    { img: '12-kanban.png', t: 'Tareas: plan del día y tablero, unidos', b: 'El plan del día y el Kanban son lo mismo visto de dos maneras. En Lista respondes a «qué tengo hoy y cuánto llevo»; en Tablero, a «en qué estado está cada cosa» (Por hacer · En progreso · Hecho). Cada tarea —y cada tarjeta del lienzo— se desglosa en pasos con su barra de progreso; marcar el primer paso la pone en marcha sola. Doble clic sobre cualquier texto para editarlo, y arrastra para reordenar o cambiar de columna.' },
  ] },
