...
var GUIA_SECS = [
  ...
  { t: 'Organizar y actuar', items: [
    { img: '06-menu-tarjeta.png', t: 'Barra de texto sobre la selección', b: 'Marca texto dentro de una nota y aparece justo encima una barra con negrita, cursiva, subrayado, tachado, resaltado y código (también con ⌘/Ctrl+B, I, U). Al lado: títulos y cita, listas numeradas, con viñetas o de casillas, sangría, tipo de letra, tamaño, alineación, interlineado y color. El estilo de carácter se guarda con marcadores markdown sobre el texto plano —así la IA, el buscador y las tareas siguen leyendo tus notas— y el botón del ojo enseña el resultado ya compuesto. El tipo de letra, el tamaño y el color se ven mientras escribes, y también en la ventana emergente.' },
