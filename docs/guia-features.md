...
13 tipos de bloque: Nota, Texto, Idea, Tabla, Código, Python, JSON, cURL, Imagen, Imagen IA,
Markdown, Mermaid y Dibujo. El anillo se ajusta para no solaparse y se mantiene dentro de la
ventana. También puedes crear una Nota con **doble clic** en el vacío.
